...
public class DockingUtilities {
	...
	private static void fillCompoundChildren(CompoundDockingPanel cdp, ArrayList<Dockable> list) {
	...
	private static void fillCompoundChildren(Component c, ArrayList<Dockable> list) {
	...
	public static boolean isChildOfCompoundDockable(Dockable dockable) {
		...
		while(container != null) {
			if(container instanceof CompoundDockingPanel && ((CompoundDockingPanel) container).getDockable() != dockable) {
